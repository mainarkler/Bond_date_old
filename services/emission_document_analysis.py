...
def _fallback_summary(extraction: ExtractedDocument) -> dict[str, Any]:
    return {
        "summary": "Локальное LLM-резюме недоступно. Ниже приведён извлечённый фрагмент для первичного просмотра.",
        "key_data": [],
        "attention_points": [
        ...
        "source_excerpt": extraction.text[:3_000] or "Текст не удалось извлечь.",
